...
set-env RUSTUP_HOME (path:join $E:XDG_STATE_HOME rustup)
...
set-env CARGO_HOME (path:join $E:XDG_STATE_HOME cargo)
...
set-env NODE_REPL_HISTORY (path:join $E:XDG_STATE_HOME node_repl_history)
