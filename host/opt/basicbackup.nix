{
  ...
  my-basic-backup = pkgs.writeShellApplication {
    name = "backup.bash";
    runtimeInputs = with pkgs; [gnugrep rclone util-linux mktemp];
    text = let
    ...
    systemd = {
      ...
      services.backup = {
        ...
        script = ''
          ...
          _lock xn || exit 1
          ${lib.getExe my-basic-backup} >/var/log/backup 2>/var/log/backup.err
        '';
        serviceConfig = {
          Type = "simple";
          RestartSec = "5min";
